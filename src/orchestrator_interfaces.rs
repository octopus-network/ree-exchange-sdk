...
impl core::fmt::Display for InvokeStatus {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            InvokeStatus::_301(msg) => write!(f, "403 Transaction fee too low: {}", msg),
            ...
            InvokeStatus::_501 => write!(f, "501 Invoke is paused"),
            ...
            InvokeStatus::_599 => write!(f, "599 Invoke failed due to exchange error"),
            InvokeStatus::_701 {
                intention_index,
                error,
            } => {
